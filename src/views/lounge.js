  ...
  return (
    <div className="lounge-container">
      ...
      <div className="lounge-frame5">
        <img
          alt="BackArrowI157"
          src="/playground_assets/backarrowi157-0zmc.svg"
          className="lounge-back-arrow"
        />
        <img
          alt="BackArrowI157"
          src="/playground_assets/backarrowi157-mdbk.svg"
          className="lounge-back-arrow1"
        />
        <img
          alt="BackArrowI157"
          src="/playground_assets/backarrowi157-1t2g.svg"
        ...
        <img
          alt="Rectangle13I157"
          src="/playground_assets/rectangle13i157-7sm-200h.png"
          className="lounge-rectangle13"
        />
        <img
          alt="Rectangle14I157"
          src="/playground_assets/rectangle14i157-r3zn.svg"
        ...
        <img
          alt="BackArrowI157"
          src="/playground_assets/backarrowi157-zhxh.svg"
          className="lounge-back-arrow3"
        />
        <img
          alt="BackArrowI157"
          src="/playground_assets/backarrowi157-anmg.svg"
        ...
        <img
          alt="Rectangle15I157"
          src="/playground_assets/rectangle15i157-56fq-200h.png"
          className="lounge-rectangle15"
        />
        <img
          alt="Rectangle16I157"
          src="/playground_assets/rectangle16i157-x0ra.svg"
        ...
        <div className="lounge-component3">
          <img
            ...
            src="/playground_assets/roomrectanglei157-b548-200h.png"
        ...
        <Link to="/" className="lounge-navlink">
          <img
            alt="image1I157"
            src="/playground_assets/image1i157-jkne-200h.png"
